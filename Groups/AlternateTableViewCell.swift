...
class AlternateTableViewCell: UITableViewController {
    ...
    //        grpData = Helper.getGroupsData(locDS: localDataSource, grpName: groupNames)
        ...
        override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            ...
            if(isAddTapped){
                return  grpNames.count+1
            }
            
            else{
                return  grpNames.count
            }
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if (rowToBeEdited == indexPath.row ){
                ...
                if(indexPath.row < grpNames.count){
                    
                        
                        cell?.label1.text = grpNames[indexPath.row]
                        cell?.label2.text = String(DBHelper.getContactCount(groupName: grpNames[indexPath.row]))
                    }
...
//        
    ...
    extension AlternateTableViewCell:UITextFieldDelegate{
