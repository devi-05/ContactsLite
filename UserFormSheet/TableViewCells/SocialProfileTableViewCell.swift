...
class SocialProfileTableViewCell: UITableViewCell {
    static let identifier = "SocialProfileTableViewCell"
    let optionValues:[Int:[String]] = [0:["Twitter","Facebook","Flickr","LinkedIn","MySpace"],1:["Add Custom Service"]]
